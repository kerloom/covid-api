...
function customizeDOM(){
    ...
    FLIGHTS_LOGO_QUERY_SELECTOR = `#main > div > div > div > section > div.elementor-container.elementor-column-gap-default > div > div > div > div > div.elementor-element.elementor-element-4cf0e52.elementor-widget.elementor-widget-text-editor > div > div > p > div > div.mewtwo-widget.mewtwo-widget--${TRAVEL_ID} > section.mewtwo-flights.mewtwo-flights--virgin.mewtwo-tabs-container > div > section > div`;
    HOTELS_LOGO_QUERY_SELECTOR = `#main > div > div > div > section > div.elementor-container.elementor-column-gap-default > div > div > div > div > div.elementor-element.elementor-element-4cf0e52.elementor-widget.elementor-widget-text-editor > div > div > p > div > div.mewtwo-widget.mewtwo-widget--${TRAVEL_ID} > section.mewtwo-hotels.mewtwo-hotels--virgin.mewtwo-tabs-container > div > section > div`;
